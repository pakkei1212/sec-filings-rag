...
class EmbeddingManager:
    ...
    def __init__(self, 
                text_embedding_model: str = "nomic-ai/nomic-embed-text-v1",
    ...
    def generate_text_embeddings(self, texts: List[str]) -> Optional[List[List[float]]]:
        """
        Generate embeddings for a batch of text contents (MUCH faster).
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not embeddings:
                    logger.error("Ollama returned zero embeddings")
                    return None
            ...
            logger.error("Failed to generate text embeddings", exc_info=True)
            return None
