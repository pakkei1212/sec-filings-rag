...
SUBMISSIONS_DIR = Path(str(DATA_DIR / "submissions"))
IMAGES_DIR = Path(str(DATA_DIR / "sec_images"))
...
EMBEDDING_MODEL_ALIAS = "nomic-embed-text"
...
# config.py
# ---------------------------------
# HTML tag classification for narrative extraction
# SEC / EDGAR optimized
# ---------------------------------
...
# HTML tag categories
# ----------------------------
# Inline tags: NEVER create newlines
INLINE_TAGS = {
    "span", "a", "strong", "em", "b", "i", "u",
    "sup", "sub", "small", "font", "mark", "abbr"
}

# Block-level tags: paragraph / section boundaries
BLOCK_TAGS = {
...
# Containers that should be removed entirely
REMOVE_TAGS = {
    "script", "style", "noscript",
    "header", "footer", "nav", "aside"
}

# Optional: table & media (if not already handled upstream)
NON_NARRATIVE_TAGS = {
